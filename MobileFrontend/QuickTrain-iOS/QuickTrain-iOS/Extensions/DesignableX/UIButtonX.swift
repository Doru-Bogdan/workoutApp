...
class UIButtonX: UIButton {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if animate {
            ...
            UIView.animate(withDuration: 0.3, delay: animateDelay, usingSpringWithDamping: 0.5,
        ...
        if popIn {
            ...
            UIView.animate(withDuration: 0.8, delay: popInDelay, usingSpringWithDamping: 0.5,
                           initialSpringVelocity: 0, options: .allowUserInteraction, animations: {
